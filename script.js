...
function renderAddedItems() {
    ...
    addedTests.forEach(item => {
        ...
        div.innerHTML = `
            <div class="item-info">
                ...
                <span class="item-meta">${item.categoryName} · ${item.count}회 · ${benefitTag}</span>
            </div>
    ...
    addedSurgeries.forEach(item => {
        ...
        div.innerHTML = `
            <div class="item-info">
                ...
                <span class="item-meta">${groupName} · ${benefitTag}</span>
            </div>
    ...
    addedProcedures.forEach(item => {
        ...
        div.innerHTML = `
            <div class="item-info">
                <span class="item-name">${item.typeName}</span>
                <span class="item-meta">${groupName} · ${item.count}회 · ${benefitTag}</span>
            </div>
